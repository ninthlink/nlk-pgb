...
?>
<div id="menu-slidepanel" class="slidedown slidepanel">
	<div class="container">
		<div class="row">
			<div class="col-sm-6 col-md-4 col-lg-3">
				<?php wp_nav_menu( array( 'theme_location' => 'page_order', 'menu_class' => 'ajax-nav', 'items_wrap' => '<ul id="%1$s" class="nav nav-pills nav-stacked %2$s">%3$s</ul>', 'depth' => 1 ) ); ?>
			</div>
